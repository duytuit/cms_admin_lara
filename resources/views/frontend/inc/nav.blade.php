    ...
    <header class="main-header header-style-1 font-heading">
            ...
            <div class="container">
                <div class="row pt-20 pb-20">
                    <div class="col-md-3 col-xs-6">
                        <a href="index.html.htm"><img class="logo" src="assets/imgs/logo/xosolocphat.png" alt=""></a>
                    </div>
                    <div class="col-md-9 col-xs-6 text-right header-top-right ">
                        <ul class="list-inline nav-topbar d-none d-md-inline">
                            <li class="list-inline-item menu-item-has-children"><a href="#">Layouts</a>
                                <ul class="sub-menu font-medium">
                        ...
                        <button class="search-icon d-none d-md-inline"><span class="mr-15 text-muted font-medium"><i class="elegant-icon icon_search mr-5"></i>Search</span></button>
                        <button class="btn btn-radius bg-primary text-white ml-15 font-medium box-shadow">Buy Now</button>
                    </div>
                </div>
            </div>
        </div>
        <div class="header-sticky">
            <div class="container align-self-center">
                ...
                <div class="float-right header-tools text-muted font-medium">
